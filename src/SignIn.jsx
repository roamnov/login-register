...
export default function SignIn() {
  ...
  document.title = window.titleText?window.titleText:"Вход";
    ...
    <ThemeProvider theme={theme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          <img
            src={"logo.png"}
            style={{ borderRadius: "5% 5% 0 0", width: window.BASE_width_logo?window.BASE_width_logo:"45%" }} // navigator.userAgent.includes("Firefox")?"3%": "29%"
          />
          <Box
            component="form"
